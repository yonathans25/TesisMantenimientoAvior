...
Public Class Frmgestionmant3
    ...
    Private Sub picboxreparar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles picboxreparar.Click
        Frmcorrecion.cmbestacion.Text = ""
        Frmcorrecion.cmbtecnico.Text = ""
        Frmcorrecion.Cmbinspec.Text = ""
    ...
    Private Sub Frmgestionmant3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
